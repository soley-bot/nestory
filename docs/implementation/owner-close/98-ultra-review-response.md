...
- **Repository rules and product docs inspected:** the predecessor documents now consolidated into `PROJECT.md`, every file in `docs/implementation/owner-close/`, and the planning `README.md`.
