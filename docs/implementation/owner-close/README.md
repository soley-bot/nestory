...
3. [PROJECT.md](../../../PROJECT.md) - current product and engineering contract.
4. [2026-07-30 IPS Finance Workflow Simplification](../../superpowers/specs/2026-07-30-ips-finance-workflow-simplification-design.md)
...
- **Current authoritative planning:** this README, files 96 and 97, the IPS
  Finance simplification direction with its approved product/UI design, and any
  separately approved current-sequence plan. The implemented Finance
  presentation does not authorize new financial authority; new writes still
  require their own reviewed plan.
...
- **Historical evidence:** files 98 and 99 and older execution plans outside
  this directory.
- **Configuration catalog:** PR #38 is merged, but the registry remains
  read-only and non-authoritative until persistence and approval rules exist.
