...
| /finance/accounts | /finance/accounts | /finance/accounts | accessible (expected accessible) | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | loading, populated, empty, error, permission-blocked, draft, saving, success | Browser rerun pending | not-applicable | Local component, route, action, and pgTAP evidence only; browser rerun pending. |
