...
| /leases/[leaseId] | /leases/ab1560d2-6ea8-4a15-b0b3-66265aeb9a5e | not captured | not captured | not captured | not captured | not captured | not captured | loading, populated, error, permission-blocked, draft, saving, success | 0/4 pending | not-applicable | Route added after this evidence run; requires a fresh browser capture. |
