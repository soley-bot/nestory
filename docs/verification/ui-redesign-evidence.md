...
<!-- route-evidence:/leases/[leaseId] -->
| /leases/[leaseId] | /leases/ab1560d2-6ea8-4a15-b0b3-66265aeb9a5e | /leases/ab1560d2-6ea8-4a15-b0b3-66265aeb9a5e | accessible (expected accessible) | accessible (expected accessible) | accessible (expected accessible) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | loading, populated, error, permission-blocked, draft, saving, success | Browser rerun pending | not-applicable | None |
...
| /settings | /settings | /settings | accessible (expected accessible) | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | loading, populated, empty, error, permission-blocked, draft, saving, success | Browser rerun pending | redirect-normalized | None |
<!-- route-evidence:/settings/organization -->
| /settings/organization | /settings/organization | /settings/organization | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | populated, error, permission-blocked, draft, saving, success | Browser rerun pending | not-applicable | None |
<!-- route-evidence:/settings/appearance -->
| /settings/appearance | /settings/appearance | /settings/appearance | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | populated, error, permission-blocked, draft, saving, success | Browser rerun pending | not-applicable | None |
<!-- route-evidence:/settings/branches -->
| /settings/branches | /settings/branches | /settings/branches | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | populated, empty, error, permission-blocked, draft, saving, success | Browser rerun pending | not-applicable | None |
<!-- route-evidence:/settings/teams -->
| /settings/teams | /settings/teams | /settings/teams | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | populated, empty, error, permission-blocked, draft, saving, success | Browser rerun pending | not-applicable | None |
<!-- route-evidence:/settings/access -->
| /settings/access | /settings/access | /settings/access | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | loading, populated, empty, error, permission-blocked, draft, saving, success | Browser rerun pending | preserved | None |
<!-- route-evidence:/settings/roles -->
| /settings/roles | /settings/roles | /settings/roles | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | loading, populated, empty, error, permission-blocked, draft, saving, success | Browser rerun pending | not-applicable | None |
...
<!-- route-evidence:/finance/accounts -->
| /finance/accounts | /finance/accounts | /finance/accounts | accessible (expected accessible) | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | loading, populated, empty, error, permission-blocked, draft, saving, success | Browser rerun pending | not-applicable | Only Super Admin can create, edit, activate, or inactivate accounts; browser rerun pending. |
<!-- route-evidence:/finance/accounts/[accountId] -->
| /finance/accounts/[accountId] | /finance/accounts/a1000000-0000-4000-8000-000000000001 | /finance/accounts/a1000000-0000-4000-8000-000000000001 | accessible (expected accessible) | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | loading, populated, empty, error, permission-blocked | Browser rerun pending | not-applicable | Read-only activity; account lifecycle remains Super Admin-only; browser rerun pending. |
<!-- route-evidence:/finance/funding-sources -->
| /finance/funding-sources | /finance/accounts | /finance/accounts | accessible (expected accessible) | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | redirected, permission-blocked | Browser rerun pending | redirect-normalized | Legacy URL permanently redirects to Chart of Accounts; browser rerun pending. |
<!-- route-evidence:/finance/advanced -->
| /finance/advanced | /finance/advanced | /finance/advanced | accessible (expected accessible) | accessible (expected accessible) | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | loading, populated, error, permission-blocked | Browser rerun pending | not-applicable | None |
...
<!-- route-evidence:/properties/[propertyId]/finance -->
| /properties/[propertyId]/finance | /properties/10000000-0000-0000-0000-000000000001/finance | /properties/10000000-0000-0000-0000-000000000001/finance | accessible (expected accessible) | accessible (expected accessible) | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | loading, populated, empty, error, permission-blocked, draft, saving, success | Browser rerun pending | preserved | None |
<!-- route-evidence:/units/[unitId]/finance -->
| /units/[unitId]/finance | /units/20000000-0000-0000-0000-000000000001/finance | /units/20000000-0000-0000-0000-000000000001/finance | accessible (expected accessible) | accessible (expected accessible) | accessible (expected accessible) | permission-blocked (expected permission-blocked) | permission-blocked (expected permission-blocked) | login-required (expected login-required) | loading, populated, empty, error, permission-blocked, draft, saving, success | Browser rerun pending | preserved | None |
