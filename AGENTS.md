...
- A production release must pass hosted preflight before writing and hosted postflight, linked lint, and a final dry-run afterward. Unknown remote versions fail closed.
