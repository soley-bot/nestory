...
describe("workspace role capabilities", () => {
  ...
  it.each<[WorkspaceRole, readonly boolean[]]>([
    ...
    ["finance_manager", [false, false, true, false, true, false, false, false]],
    ["finance_member", [false, false, true, true, false, false, false, false]],
    ["operations_manager", [false, false, false, false, false, false, true, true]],
    ["operations_member", [false, false, false, false, false, false, false, true]],
