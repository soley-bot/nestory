...
export const timelineEvents: TimelineEvent[] = [
  {
    ...
    propertyName: "BKK1 Serviced Residence",
    propertyCode: "BKK1-SR-018",
    unitNumber: "12B",
    cost: 2450,
    currency: "USD",
    hasAttachment: true,
  ...
  },
  {
    ...
    propertyName: "Toul Kork Mixed Use Building",
    propertyCode: "TK-MU-006",
    unitNumber: "04C",
    cost: 75,
    currency: "USD",
    hasAttachment: false,
  ...
  },
  {
    ...
    propertyName: "Riverside Apartment Block",
    propertyCode: "RIV-APT-003",
    unitNumber: "07D",
    cost: 185000,
    currency: "KHR",
    hasAttachment: true,
  ...
  },
  {
    ...
    propertyName: "Daun Penh Townhouse",
    propertyCode: "DP-TH-011",
    hasAttachment: true,
    createdBy: "Admin",
