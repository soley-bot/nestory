...
describe("historical rent correction input", () => {
  ...
  it.each([
    ...
    ["historical_rent_dependent_owner_cash", "funded another owner charge"],
    ["historical_rent_tenant_credit_unsupported", "below money already collected"],
    ["historical_rent_payment_account_unavailable", "original payment account"],
    ["historical_rent_owner_roster_changed", "Owner shares have changed"],
    ["privileged_email_step_up_required", "email verification"],
