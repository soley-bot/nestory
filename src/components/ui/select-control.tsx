          ...
          >
            <Select.Viewport className="p-1">
              <Select.Group>
                {options.map((option) => (
                  <Select.Item
                    className="relative flex min-h-8 cursor-default select-none items-center rounded-md px-2 pr-8 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[highlighted]:bg-accent-soft data-[highlighted]:text-accent"
