...
- Finance is the deliberate exception to the inspector/drawer default. Finance
  lists use one compact table, a centered modal or dedicated detail page, and a
  compact totals line. Do not add side inspectors or stat-card grids to
  Finance workspaces.
...
- On Finance routes, prefer table -> centered modal or dedicated page. Keep
  create and lifecycle forms focused, preserve the filtered list context, and
  never require a side inspector to understand or act on a transaction.
